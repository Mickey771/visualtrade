...
const ExploreOurCommodity = () => {
  return (
    <section className="bg-[rgb(25,31,46)] pt-[150px]">
      <div className="w-full max-w-max mx-auto flex flex-col items-center">
        ...
        <table className="w-full bg-[hsl(223,64%,8%)] rounded-[6px] text-white mt-12">
      ...
      <div className="bg-base py-[35px] mt-20 flex justify-center items-center text-center">
        <div className="flex flex-col px-[80px] gap-2">
          <h3 className="text-[2rem] font-bold">12 Trillion</h3>
          <p className="text-[1.125rem]">Monthly Trading Volume</p>
        </div>
        <div className="w-[2px] h-[60px] bg-gradient-to-b from-[#6c757d] via-[#6c757d] to-[rgb(108,117,125)]  "></div>
        <div className="flex flex-col px-[80px] gap-2 ">
          <h3 className="text-[2rem] font-bold">2.5 Billion</h3>
          <p className=" text-[1.125rem]">Trades Executed in 2024</p>
        </div>
        <div className="w-[2px] h-[60px] bg-gradient-to-b from-[#6c757d] via-[#6c757d] to-[rgb(108,117,125)]  "></div>
        <div className="flex flex-col px-[80px] gap-2 ">
          <h3 className="text-[2rem] font-bold">64,000 +</h3>
          <p className="text-[1.125rem]">Registered Partners</p>
        </div>
        <div className="w-[2px] h-[60px] bg-gradient-to-b from-[#6c757d] via-[#6c757d] to-[rgb(108,117,125)]  "></div>
        <div className="flex flex-col px-[80px] gap-2 ">
          <h3 className="text-[2rem] font-bold">4.6 +</h3>
          <p className="text-[1.125rem]">Trustpilot Rating</p>
        </div>
      </div>
    </section>
  );
