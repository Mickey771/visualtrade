  ...
  return (
    <section>
      ...
      <div className="bg-[hsl(222,65%,8%)] p-[20px] md:p-[50px] lg:p-[75px]">
        <div className=" w-full max-w-max mx-auto flex flex-col gap-4 text-white">
          ...
          <h3 className="text-[2rem] font-semibold">Interpretation</h3>
          <p className="text-[rgba(255,255,255,0.7)]">
          ...
          <h3 className="text-[2rem] font-semibold">Definitions</h3>
          <p className="text-[rgba(255,255,255,0.7)]">
          ...
          <ul className="flex flex-col gap-2">
            ...
            <li>
              <p className="text-[rgba(255,255,255,0.7)]">
                ...
                in this Agreement) refers to QuantEmpowerAI, 68 Northbourne Ave,
            ...
            <li>
              <p className="text-[rgba(255,255,255,0.7)]">
                <strong>Country</strong> refers to: Australian Capital
                Territory, Australia
              </p>
            </li>
            <li>
            ...
            <li>
              <p className="text-[rgba(255,255,255,0.7)]">
                <strong>Website</strong> refers to Quant Empower AI, accessible
                from{" "}
                <a
                  href="QuantEmpowerAI.com"
          ...
          <h3 className="text-[2rem] font-semibold">Types of Data Collected</h3>
          <h4 className="text-[1.8rem] font-semibold">Personal Data</h4>
          <p className="text-[rgba(255,255,255,0.7)]">
          ...
          <ul className="flex flex-col gap-2">
            <li>
              <p className="text-[rgba(255,255,255,0.7)]">Email address</p>
            </li>
            <li>
              <p className="text-[rgba(255,255,255,0.7)]">
            ...
            <li>
              <p className="text-[rgba(255,255,255,0.7)]">Phone number</p>
            </li>
            <li>
              <p className="text-[rgba(255,255,255,0.7)]">
            ...
            <li>
              <p className="text-[rgba(255,255,255,0.7)]">Usage Data</p>
            </li>
          </ul>
          <h4 className="text-[1.8rem] font-semibold">Usage Data</h4>
          <p className="text-[rgba(255,255,255,0.7)]">
          ...
          <h4 className="text-[1.8rem] font-semibold">Business Transactions</h4>
          <p className="text-[rgba(255,255,255,0.7)]">
          ...
          <h4 className="text-[1.8rem] font-semibold">Law enforcement</h4>
          <p className="text-[rgba(255,255,255,0.7)]">
          ...
          <h2 className="text-[2.2rem] font-semibold">Children's Privacy</h2>
          <p className="text-[rgba(255,255,255,0.7)]">
          ...
          <h2 className="text-[2.2rem] font-semibold">Contact Us</h2>
          <p className="text-[rgba(255,255,255,0.7)]">
          ...
          <ul>
            <li className="text-[rgba(255,255,255,0.7)]">
              By email: Support@Quantempowerai.com
            </li>
          </ul>
        </div>
      </div>
